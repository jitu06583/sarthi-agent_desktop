    ...
    defaults = {
        ...
        "agent": {
            ...
            "personalities": {
                ...
                "pirate": "Arrr! Ye be talkin' to Captain Sarthi, the most tech-savvy pirate to sail the digital seas! Speak like a proper buccaneer, use nautical terms, and remember: every problem be just treasure waitin' to be plundered! Yo ho ho!",
                "shakespeare": "Hark! Thou speakest with an assistant most versed in the bardic arts. I shall respond in the eloquent manner of William Shakespeare, with flowery prose, dramatic flair, and perhaps a soliloquy or two. What light through yonder terminal breaks?",
                "surfer": "Duuude! You're chatting with the chillest AI on the web, bro! Everything's gonna be totally rad. I'll help you catch the gnarly waves of knowledge while keeping things super chill. Cowabunga!",
                "noir": "The rain hammered against the terminal like regrets on a guilty conscience. They call me Sarthi - I solve problems, find answers, dig up the truth that hides in the shadows of your codebase. In this city of silicon and secrets, everyone's got something to hide. What's your story, pal?",
...
def _notify_session_finalize(
    *,
    ...
    try:
        from sarthi_cli.plugins import invoke_hook as _invoke_hook
        _invoke_hook(
            "on_session_finalize",
...
def _prune_stale_worktrees(repo_root: str, max_age_hours: int = 24) -> None:
    ...
    *dead*-locked one (owning pid gone — a crashed session) is unlocked first
    ...
    for entry in worktrees_dir.iterdir():
        if not entry.is_dir() or not entry.name.startswith("sarthi-"):
            continue
...
# - Gold: #2DD4BF (headers, highlights)
# - Amber: #10B981 (secondary highlights)
# - Bronze: #2563EB (tertiary elements)
# - Light: #FFF8DC (text)
# - Dim: #059669 (muted text)

# ANSI building blocks for conversation display
_ACCENT_ANSI_DEFAULT = "\033[1;38;2;255;215;0m"  # True-color #2DD4BF bold — fallback
_BOLD = "\033[1m"
_RST = "\033[0m"
...
# to remap "near-white" skin colors (e.g. #FFF8DC banner_text, #059669
...
_LIGHT_MODE_REMAP: dict[str, str] = {
    ...
    "#2DD4BF": "#9A6B00",   # gold -> dark goldenrod (readable on cream)
    "#10B981": "#8A5A00",   # amber -> dark amber
    "#059669": "#5C4500",   # dark goldenrod -> deeper brown (more contrast)
    ...
    "#F5F5F5": "#1A1A1A",
    "#FFF0D4": "#1A1A1A",
    "#2563EB": "#8A4F1A",   # bronze -> darker bronze
    "#FFEFB5": "#3A2A00",
...
class _SkinAwareAnsi:
    ...
    def __init__(self, skin_key: str, fallback_hex: str = "#2DD4BF", *, bold: bool = False):
...
_ACCENT = _SkinAwareAnsi("response_border", "#2DD4BF", bold=True)
...
# Terminal.app modes.  Hardcoded skin colors like #059669
...
def _accent_hex() -> str:
    ...
    try:
        from sarthi_cli.skin_engine import get_active_skin
        return get_active_skin().get_color("ui_accent", "#10B981")
    except Exception:
        return "#10B981"
...
def _build_compact_banner() -> str:
    ...
    title_color = _skin.get_color("banner_title", "#10B981") if _skin else "#10B981"
    dim_color = _skin.get_color("banner_dim", "#059669") if _skin else "#059669"
...
class SarthiCLI(CLIAgentSetupMixin, CLICommandsMixin):
    """
    ...
    def __init__(
        ...
        elif os.getenv("SARTHI_MAX_ITERATIONS"):
            try:
                self.max_turns = int(os.getenv("SARTHI_MAX_ITERATIONS", ""))
            except (TypeError, ValueError):
                self.max_turns = 90
        else:
            self.max_turns = 90
    ...
    def _show_status(self):
        ...
        try:
            ...
            separator_color = skin.get_color("banner_dim", "#059669")
            accent_color = skin.get_color("ui_accent", "#10B981")
            label_color = skin.get_color("ui_label", "#DAA520")
        except Exception:
            separator_color, accent_color, label_color = "#059669", "#10B981", "cyan"
        toolsets_info = ""
    ...
    def show_help(self):
        ...
        _cprint(f"\n  {_DIM}Tip: Just type your message to chat with Sarthi!{_RST}")
    ...
    def save_conversation(self):
        """Save the current conversation to a JSON snapshot under ~/.sarthi/sessions/saved/.
        ...
        DB, so the live session remains resumable via ``sarthi --resume <id>``
        ...
        try:
            ...
            return
        path = saved_dir / f"sarthi_conversation_{timestamp}.json"
        ...
        if canonical in {"quit", "exit"}:
            ...
            if self._app:
                ...
                try:
                    ...
                    try:
                        from sarthi_cli.skin_engine import get_active_skin
                        _tip_color = get_active_skin().get_color("banner_dim", "#059669")
                    except Exception:
                        _tip_color = "#059669"
    ...
    def _print_nous_credits_block(self) -> bool:
        ...
        wall-clock-bounded inside the helper; also honors SARTHI_DEV_CREDITS_FIXTURE
    ...
    def _show_credits(self):
        ...
        if not view.logged_in:
            ...
            print("  Run `sarthi portal` to log in, then /credits.")
            return
    ...
    def _show_billing(self, command: str = "/billing"):
        ...
        if not state.logged_in:
            ...
            if state.error:
                ...
                _cprint(f"  💳 {_d('Not logged into Nous Portal.')}")
                print("  Run `sarthi portal` to log in, then /billing.")
            return
    ...
    def _billing_confirm_and_charge(self, state, amount):
        ...
        from sarthi_cli.nous_billing import (
            BillingError,
    ...
    def _billing_render_charge_error(self, state, exc):
        ...
        from sarthi_cli.nous_billing import BillingRateLimited
    ...
    def _billing_handle_scope_required(self, state):
        ...
        if not getattr(self, "_app", None):
            print("  Run `sarthi portal` and approve terminal billing, then retry.")
            return
        confirm_choices = [
        ...
        if choice != "yes":
            ...
            return
        try:
            from sarthi_cli.auth import step_up_nous_billing_scope
    ...
    def run(self):
        ...
        try:
            ...
            if not is_seen(self.config, OPENCLAW_RESIDUE_FLAG) and detect_openclaw_residue():
                try:
                    _resid_color = _welcome_skin.get_color("banner_dim", "#059669")
                except Exception:
                    _resid_color = "#059669"
        ...
        try:
            ...
            _tip = get_random_tip()
            try:
                _tip_color = _welcome_skin.get_color("banner_dim", "#059669")
            except Exception:
                _tip_color = "#059669"
            self._console_print(f"[dim {_tip_color}]✦ Tip: {_tip}[/]")
        except Exception:
        ...
        if _preserve_ctrl_enter_newline():
            ...
            def handle_ctrl_enter_newline(event):
                ...
                conflicting Sarthi binding. See issue #22379.
                """
                event.current_buffer.insert_text('\n')
        ...
        self._tui_style_base = {
            ...
            'status-bar-strong': 'bg:#1a1a2e #2DD4BF bold',
            'status-bar-dim': 'bg:#1a1a2e #8B8682',
            'status-bar-good': 'bg:#1a1a2e #8FBC8F bold',
            'status-bar-warn': 'bg:#1a1a2e #2DD4BF bold',
            ...
            'completion-menu.completion.current': 'bg:#333355 #2DD4BF',
            'completion-menu.meta.completion': 'bg:#1a1a2e #888888',
            'completion-menu.meta.completion.current': 'bg:#333355 #10B981',
            # Clarify question panel
            'clarify-border': '#2563EB',
            'clarify-title': '#2DD4BF bold',
            'clarify-question': '#FFF8DC bold',
            'clarify-choice': '#AAAAAA',
            'clarify-selected': '#2DD4BF bold',
            'clarify-active-other': '#2DD4BF italic',

...
| `timeout` | `60` | Seconds Sarthi waits for an approval reply before timing out. |
...
- Set automatically in the [official Docker image](https://github.com/jitendra-singh-thakur/sarthi-agent) (`SARTHI_WRITE_SAFE_ROOT=/opt/data`)
...
[i10270]: https://github.com/jitendra-singh-thakur/sarthi-agent/issues/10270
:::

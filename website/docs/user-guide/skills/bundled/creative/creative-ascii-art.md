...
```bash
python3 -m pyfiglet "SARTHI" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SARTHI&font=Slant" | boxes -d stone
```

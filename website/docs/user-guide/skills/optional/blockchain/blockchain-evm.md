...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Sarthi Agent |
| License | MIT |
...
Helper script path: `~/.sarthi/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.sarthi/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.sarthi/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.sarthi/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```

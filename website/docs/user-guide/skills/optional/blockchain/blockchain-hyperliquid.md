...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Sarthi Agent |
| License | MIT |
...
The script reads `${SARTHI_HOME:-~/.sarthi}/.env` for two optional defaults:
...
Helper script: `~/.sarthi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.sarthi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${SARTHI_HOME:-~/.sarthi}/.env`.
...
```bash
python3 ~/.sarthi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.sarthi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \

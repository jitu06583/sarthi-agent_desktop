...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative/tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + Sarthi Agent |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This Sarthi skill mirrors that guidance for Sarthi.)

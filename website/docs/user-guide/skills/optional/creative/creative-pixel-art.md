...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.sarthi/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.sarthi/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Sarthi installs package this)

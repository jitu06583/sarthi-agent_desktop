...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Sarthi Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $SARTHI_OSINT_CACHE/icij/ (default: ~/.cache/sarthi-osint/icij/).
...
# Set SARTHI_OSINT_UA=your-app/1.0 (your@email) to identify yourself

...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`sarthi-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sarthi-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Sarthi Agent via the native MCP client. This is the preferred
...
Then configure Sarthi Agent to connect via HTTP:

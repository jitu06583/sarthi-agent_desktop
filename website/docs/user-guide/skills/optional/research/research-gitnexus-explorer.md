...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/research/gitnexus-explorer` |
...
| Related skills | [`sarthi-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sarthi-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |

...
- User wants **Sarthi itself to drive a browser** → use Sarthi' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.

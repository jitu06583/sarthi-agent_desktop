...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing sarthi tool access (web_search, file ops). Stateless. |

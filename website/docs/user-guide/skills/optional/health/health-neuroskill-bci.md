...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/health/neuroskill-bci` |
...
Connect Sarthi to a running [NeuroSkill](https://neuroskill.com/) instance to read

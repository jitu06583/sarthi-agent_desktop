...
| | |
|---|---|
| Source | Optional — install with `sarthi skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Sarthi Agent |
| License | MIT |
...
```
SCRIPT=~/.sarthi/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.sarthi/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```

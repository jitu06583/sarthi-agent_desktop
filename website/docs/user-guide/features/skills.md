...
```bash
curl -fsSL https://sarthi-agent.vercel.app/install.sh | bash -s -- --no-skills
```
...
[Skills Hub](https://sarthi-agent.vercel.app/docs) page — instead of a
...
Sarthi supports marketplace repos that publish Claude-compatible plugin/marketplace manifests.

Known integrated sources include:
- [anthropics/skills](https://github.com/anthropics/skills)
- [aiskillstore/marketplace](https://github.com/aiskillstore/marketplace)

Sarthi source id: `claude-marketplace`
...
If your skills don't live under `skills/` (common when you're adding a `skills/` subtree to an existing project), edit the tap entry in `~/.sarthi/.hub/taps.json`:
...
Taps are stored in `~/.sarthi/.hub/taps.json` (created on demand).

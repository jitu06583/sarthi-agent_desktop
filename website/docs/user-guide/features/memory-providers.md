...
See the [config reference](https://github.com/jitendra-singh-thakur/sarthi-agent/blob/main/plugins/memory/honcho/README.md) and [Honcho integration guide](https://docs.honcho.dev/v3/guides/integrations/sarthi).
...
echo "OPENVIKING_ENDPOINT=http://localhost:1933" >> ~/.sarthi/.env
# Authenticated servers should use a user/admin API key:
echo "OPENVIKING_API_KEY=..." >> ~/.sarthi/.env
```
...
See [plugin README](https://github.com/jitendra-singh-thakur/sarthi-agent/blob/main/plugins/memory/hindsight/README.md) for the full configuration reference.
...
| **Requires** | `pip install supermemory` + [API key](http://app.supermemory.ai/integrations?connect=sarthi) |

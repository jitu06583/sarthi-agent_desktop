...
- Post-meeting artifacts (transcript, speaker-attributed notes, action items) saved under `~/.sarthi/cache/google_meet/<meeting_id>/`
...
**Disabling:** `sarthi plugins disable google_meet`. Any cached transcripts and recordings stay in `~/.sarthi/cache/google_meet/` until you remove them.

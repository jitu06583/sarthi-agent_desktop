...
- **You just want to back up a profile on your own machine.** Use [`sarthi profile export` / `import`](../reference/profile-commands.md#sarthi-profile-export) — that's what those are for.
...
- [`sarthi profile export` / `import`](../reference/profile-commands.md#sarthi-profile-export) — local backup / restore (not distribution)

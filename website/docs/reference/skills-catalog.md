...
| [`sarthi-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sarthi-agent) | Use, configure, theme, extend, and orchestrate Sarthi Agent. | `autonomous-ai-agents/sarthi-agent` |
...
| [`sarthi-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-sarthi-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/sarthi-agent-skill-authoring` |
| [`inspecting-sarthi-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-sarthi-desktop-dom) | Read the live Sarthi desktop DOM/CSS over CDP. | `software-development/inspecting-sarthi-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .sarthi/plans/; no execution. | `software-development/plan` |

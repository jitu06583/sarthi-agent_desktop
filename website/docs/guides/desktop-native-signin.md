...
description: "How the Sarthi Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Sarthi Desktop app connects to a **gated gateway** (a hosted or
...
For Sarthi specifically, native sign-in means:
...
- [Run Sarthi with Nous Portal](./run-sarthi-with-nous-portal.md)

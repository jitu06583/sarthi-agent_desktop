...
```bash
sarthi cron create "every day at 9am" \
...
If a model is genuinely unavailable, [open an issue](https://github.com/jitendra-singh-thakur/sarthi-agent/issues) — most gaps are routing config we can update.

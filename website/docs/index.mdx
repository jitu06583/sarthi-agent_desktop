...
slug: /
sidebar_position: 0
title: "Sarthi Agent Documentation"
...
After installing, run `sarthi setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Sarthi Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Sarthi safely  |
| 🧭 **[Use MCP with Sarthi](/guides/use-mcp-with-sarthi)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Sarthi](/guides/use-voice-mode-with-sarthi)** | Hands-on setup and usage patterns for Sarthi voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Sarthi' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Sarthi                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Sarthi, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Sarthi, Nomos, and Psyche models

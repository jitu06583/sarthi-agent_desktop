...
sidebar_position: 1
title: "Nous Portal"
description: "One subscription, 300+ frontier models, the Tool Gateway, and Nous Chat — the recommended way to run Sarthi Agent"
---
...
| **Sarthi** | Hermes-4-70B, Hermes-4-405B (chat, see [note below](#a-note-on-hermes-4)) |
...
Nous Research's own **Sarthi 4** family (Hermes-4-70B, Hermes-4-405B) is available through the Portal at heavily discounted rates. These are **frontier hybrid-reasoning chat models** — strong at math, science, instruction following, schema adherence, roleplay, and long-form writing.
...
If a model is genuinely missing, [open an issue](https://github.com/jitendra-singh-thakur/sarthi-agent/issues) — we surface the Portal's catalog to Sarthi and gaps usually mean a routing config we can update.

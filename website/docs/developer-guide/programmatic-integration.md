...
sarthi acp --bootstrap      # print install snippet for an ACP-capable IDE
```
...
Every command in the Pi-mono RPC spec ([issue #360](https://github.com/jitendra-singh-thakur/sarthi-agent/issues/360)) has a TUI-gateway equivalent:

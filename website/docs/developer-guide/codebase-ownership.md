...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `sarthi_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `sarthi_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Sarthi Plugin](plugins/index.md) |
...
| Session storage | `sarthi_state.py` | [Session Storage](session-storage.md) |

#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Sarthi docs site.
...
Both publish at:
  https://sarthi-agent.vercel.app/docs/llms.txt
  https://sarthi-agent.vercel.app/docs/llms-full.txt
...
SITE_BASE = "https://sarthi-agent.vercel.app/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Sarthi as a Python Library", None),
        ("guides/use-mcp-with-sarthi", "Use MCP with Sarthi", None),
        ("guides/use-voice-mode-with-sarthi", "Use Voice Mode with Sarthi", None),
        ("guides/use-soul-with-sarthi", "Use SOUL.md with Sarthi", None),
        ("guides/build-a-sarthi-plugin", "Build a Sarthi Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Sarthi"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "sarthi-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/jitendra-singh-thakur/sarthi-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Sarthi Agent — Full Documentation\n",
        (
            "This file is the entire Sarthi Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Sarthi, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://sarthi-agent.vercel.app/docs\n",
        "Short index: https://sarthi-agent.vercel.app/docs/llms.txt\n",
        "\n---\n\n",
    ]

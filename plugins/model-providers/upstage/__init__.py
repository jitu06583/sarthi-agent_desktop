...
# When the user hasn't picked a reasoning effort, Sarthi passes
...
# ON at this effort — matching the "medium (default)" that Sarthi' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Sarthi' effort vocabulary onto Solar's accepted set. xhigh/max/

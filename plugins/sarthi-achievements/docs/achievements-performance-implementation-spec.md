# Sarthi Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.sarthi/plugins/sarthi-achievements/state.json` (existing unlock state)
  - `~/.sarthi/plugins/sarthi-achievements/scan_snapshot.json` (new)
  - `~/.sarthi/plugins/sarthi-achievements/scan_checkpoint.json` (new)

# Sarthi Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.sarthi/plugins/sarthi-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.sarthi/plugins/sarthi-achievements/scan_checkpoint.json`.

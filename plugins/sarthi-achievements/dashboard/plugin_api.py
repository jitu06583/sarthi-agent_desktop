...
def state_path() -> Path:
    return get_sarthi_home() / "plugins" / "sarthi-achievements" / "state.json"


def snapshot_path() -> Path:
    return get_sarthi_home() / "plugins" / "sarthi-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return get_sarthi_home() / "plugins" / "sarthi-achievements" / "scan_checkpoint.json"

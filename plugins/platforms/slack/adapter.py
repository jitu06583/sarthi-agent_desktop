...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            # Sarthi does not currently need to route them into the agent loop.
    ...
    async def _handle_slack_message(
        ...
        if original_text.startswith("!"):
            try:
                ...
                # forms like ``!stop@sarthi`` still resolve.
...
def interactive_setup() -> None:
    ...
    print()
    print_info("   Full guide: https://sarthi-agent.vercel.app/docs/user-guide/messaging/slack/")
    print()
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'sarthi-agent[slack]'",

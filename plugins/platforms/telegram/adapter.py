...
# trigger its own recovery path. Refs: NousResearch/sarthi-agent#59614
...
class TelegramAdapter(BasePlatformAdapter):
        ...
        try:
            if app and app.updater and app.updater.running:
                try:
                    ...
                    # Refs: NousResearch/sarthi-agent#58270
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            disable_fallback = (os.getenv("SARTHI_TELEGRAM_DISABLE_FALLBACK_IPS", "").strip().lower() in {"1", "true", "yes", "on"})
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'sarthi-agent[telegram]'",

...
Config: ~/.sarthi/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.sarthi/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_sarthi_home()`` helper (SARTHI_HOME-aware and
...
RULES_FILE = get_sarthi_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_sarthi_home() / "feishu_comment_pairing.json"

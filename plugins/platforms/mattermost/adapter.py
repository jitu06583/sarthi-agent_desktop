...
required — uses aiohttp which is already a Sarthi dependency.
...
def interactive_setup() -> None:
    ...
    ``sarthi_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Sarthi delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # sarthi_cli/setup.py::_setup_mattermost function.

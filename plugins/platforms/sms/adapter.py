...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Sarthi gateway adapter.

    Each inbound phone number gets its own Sarthi session (multi-tenant).
...
# static dict in sarthi_cli/gateway.py, and the _send_sms dispatch in

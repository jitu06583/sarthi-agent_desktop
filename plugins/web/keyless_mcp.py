...
two endpoints so a fresh Sarthi install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``sarthi tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `sarthi tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `sarthi tools` for reliable service."
            ),
        }

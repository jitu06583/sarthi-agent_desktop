...
def resolve_active_host() -> str:
    ...
    Resolution order:
      ...
      2. Active profile name via profiles system -> ``sarthi.<profile>``
      3. Fallback: ``"sarthi"`` (default profile)
    """
...
class HonchoClientConfig:
    ...
    # Max chars of dialectic result to inject into Sarthi system prompt
...
def get_honcho_client(config: HonchoClientConfig | None = None) -> Honcho:
    ...
    def _build() -> "Honcho":
        ...
        # the "go run sarthi honcho setup" hint they used to.
        try:

...
Configuration
-------------
Secret (lives in $SARTHI_HOME/.env or the environment):
...
Behavioral settings (live in $SARTHI_HOME/mem0.json, set via `sarthi memory
setup`):
  ...
  agent_id           — Agent identifier (default: sarthi)
...
def _load_config() -> dict:
    """Load config from env vars, with $SARTHI_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "sarthi"),
        "oss": {},
    }
    ...
    config_path = get_sarthi_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, sarthi_home):
        """Write config to $SARTHI_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $SARTHI_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "sarthi")

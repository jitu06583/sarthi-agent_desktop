...
(function () {
  ...
  const DOCS_URL = "https://sarthi-agent.vercel.app/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://sarthi-agent.vercel.app/docs/user-guide/features/kanban-tutorial";
  ...
  function InlineCreate(props) {
    ...
    return h("div", { className: "sarthi-kanban-inline-create" },
      h("textarea", {
        value: title,
  ...
  function TaskDrawer(props) {
    ...
    return h("div", { className: "sarthi-kanban-drawer-shade", onClick: props.onClose },
      h("div", {
        ...
        data ? h("div", { className: "sarthi-kanban-drawer-comment-row" },
          h(Input, {
            value: newComment,

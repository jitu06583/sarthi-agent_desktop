...
``_check_spotify_available()`` — when the user has not run ``sarthi auth
spotify``, the tools remain registered (so they appear in ``sarthi
...
The Spotify auth flow (``sarthi auth spotify``), CLI plumbing, and docs

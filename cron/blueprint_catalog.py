...
renders natively:
  ...
  * Docs catalog          -> a copy-paste command + a ``sarthi://`` deep-link
...
def blueprint_deeplink(blueprint: AutomationBlueprint, values: Optional[Dict[str, Any]] = None) -> str:
    """Build the ``sarthi://blueprint/<key>?slot=val`` deep-link URL."""
    ...
    return f"sarthi://blueprint/{quote(blueprint.key)}{qs}"

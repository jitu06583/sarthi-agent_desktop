...
def get_sarthi_home() -> Path:
    ...
    Reads SARTHI_HOME env var, falls back to the platform-native default.
    ...
    ``sarthi_cli/kanban_db.py``).  See https://github.com/jitendra-singh-thakur/sarthi-agent/issues/18594.
    """
...
def _get_packaged_data_dir(name: str) -> Path | None:
    ...
    Used to discover bundled skills/optional-skills when Sarthi is installed
...
def get_bundled_skills_dir(default: Path | None = None) -> Path:
    ...
    Resolution order:
        ...
        4. ``<SARTHI_HOME>/skills`` last-resort
    """
...
def get_sarthi_dir(new_subpath: str, old_name: str) -> Path:
        ...
        for name in names:
            ...
            if candidate.is_file() and (
                ...
                if node_tool_runnable(resolved):
                    return resolved
                broken_present = True
    if broken_present and heal_sarthi_managed_node():
        for directory in iter_sarthi_node_dirs():
            for name in names:
                candidate = directory / name
                if candidate.is_file() and (
...
def secure_parent_dir(path: Path) -> None:
    ...
    See https://github.com/jitendra-singh-thakur/sarthi-agent/issues/25821.
    """
...
def is_container() -> bool:
    ...
    See: NousResearch/sarthi-agent#47111
    """

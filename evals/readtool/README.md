...
benchmarked ten harnesses on hostile-file handling — and whose Sarthi column
...
Every task runs the full Sarthi agent (file + terminal + search toolsets)
...
Rules of engagement (from sarthibench discipline):

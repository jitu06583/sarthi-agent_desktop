...
from environment variables:
  ...
  - ``SARTHI_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``SARTHI_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``SARTHI_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``sarthi cron run`` in the CLI, ``sarthi send``, a
...
_STRICT_ENV = "SARTHI_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "SARTHI_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "SARTHI_MEDIA_TRUST_RECENT_FILES"

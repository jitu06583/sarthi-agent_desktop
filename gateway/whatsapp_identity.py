...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SARTHI_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_sarthi_dir("platforms/whatsapp/session", "whatsapp/session")

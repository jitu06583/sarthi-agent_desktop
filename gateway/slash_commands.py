...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_help_command(self, event: MessageEvent) -> str:
        ...
        from sarthi_cli.commands import gateway_help_lines
        lines = [
    ...
    async def _handle_personality_command(self, event: MessageEvent) -> str:
        ...
        if not personalities:
            return t("gateway.personality.none_configured", path=display_sarthi_home())
    ...
    async def _handle_rollback_command(self, event: MessageEvent) -> str:
        ...
        try:
            import yaml as _y
            _cfg_path = _sarthi_home / "config.yaml"
            if _cfg_path.exists():
    ...
    async def _handle_reasoning_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _sarthi_home, _platform_config_key
    ...
    async def _handle_fast_command(self, event: MessageEvent) -> str:
        ...
        from gateway.run import _sarthi_home, _load_gateway_config, _resolve_gateway_model
        import yaml
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        ...
        try:
            if sys.platform == "win32":
                ...
                # sarthi_cmd is a list of argv parts we can pass directly

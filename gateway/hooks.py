...
Hooks are discovered from ~/.sarthi/hooks/ directories, each containing:
...
HOOKS_DIR = get_sarthi_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"sarthi_hook_{hook_name}"

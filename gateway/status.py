...
def _consume_pid_marker_for_self(
    ...
    *,
    ...
    # running under a different SARTHI_HOME. When two profile gateway
    # services share the same default ~/.sarthi (SARTHI_HOME not set
    ...
    # field is absent in markers written by older Sarthi versions; treat
    ...
    if replacer_home is not None and replacer_home != str(_get_process_sarthi_home()):
        return False
...
def write_takeover_marker(target_pid: int) -> bool:
    ...
    try:
        ...
        record = {
            ...
            "replacer_sarthi_home": str(_get_process_sarthi_home()),

...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Sarthi session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Sarthi session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Sarthi agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Sarthi Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Sarthi gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Sarthi session in it",

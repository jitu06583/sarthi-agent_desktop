...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateSarthi: string;
    updateSarthiConfirmMessage?: string;
    updateSarthiConfirmNow?: string;
    updateSarthiConfirmTitle?: string;
    updatingSarthi: string;
  ...
  // ── Achievements plugin (plugins/sarthi-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;

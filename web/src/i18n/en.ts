...
export const en: Translations = {
  ...
  status: {
    ...
    updateSarthiConfirmMessage:
      "This runs sarthi update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateSarthiConfirmNow: "Update now",
    updateSarthiConfirmTitle: "Update Sarthi?",
    updatingSarthi: "Updating Sarthi…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Sarthi plugins (`sarthi plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.sarthi/plugins/?",
    removeHint: "Only user-installed plugins under ~/.sarthi/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.sarthi/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Sarthi doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Sarthi Achievements",
      subtitle:
        "Collectible Sarthi badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Sarthi session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Sarthi more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Sarthi sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Sarthi is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Sarthi Agent ☤",
    },
  },

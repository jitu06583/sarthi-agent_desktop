 ...
 *
 * Values mirror sarthi_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Sarthi default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Sarthi' default when unset). */

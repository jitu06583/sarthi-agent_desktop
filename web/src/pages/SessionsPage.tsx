...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    sarthi_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__sarthi_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Sarthi-Session-Token":
              (window as unknown as { __SARTHI_SESSION_TOKEN__?: string })
                .__SARTHI_SESSION_TOKEN__ ?? "",
          },
        });

...
const STORAGE_KEY = "sarthi-dashboard-theme";
...
const FONT_STORAGE_KEY = "sarthi-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `sarthi_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "sarthi-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-sarthi-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-sarthi-theme-font", "true");

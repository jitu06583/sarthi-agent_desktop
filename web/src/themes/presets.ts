 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `sarthi_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Sarthi Teal",
  description: "Classic dark teal — the canonical Sarthi look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Sarthi Teal (Large)",
  description: "Sarthi Teal with bigger fonts and roomier spacing",

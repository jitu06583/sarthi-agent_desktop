 ...
 * `window.__SARTHI_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Sarthi brand in the top bar
 ...
 *  `window.__SARTHI_PLUGINS__.registerSlot(...)`.
 *

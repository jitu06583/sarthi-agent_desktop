 ...
 *
 * Plugins call window.__SARTHI_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SARTHI_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SARTHI_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SARTHI_PLUGIN_SDK__ = {
    ...
    // window.__SARTHI_SESSION_TOKEN__ directly.
    authedFetch,

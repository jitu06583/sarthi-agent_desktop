/**
 * Sarthi Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SARTHI_PLUGIN_SDK__`` and
 * ``window.__SARTHI_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SARTHI_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``SarthiPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@sarthi/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SARTHI_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SARTHI_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SARTHI_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface SarthiPluginSDK {
...
declare global {
  interface Window {
    __SARTHI_PLUGIN_SDK__?: SarthiPluginSDK;
    __SARTHI_PLUGINS__?: PluginRegistry;
  }
}

...
Registry of record: `sarthi_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Sarthi config+state snapshots (CLI)
...
/update                  Update Sarthi to latest

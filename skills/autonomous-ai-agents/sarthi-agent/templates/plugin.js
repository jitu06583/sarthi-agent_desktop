/**
 * Sarthi desktop plugin template. Save as:
 *   <sarthi home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <sarthi home> is ~/.sarthi by default, or ~/.sarthi/profiles/<name>
 * when running a named profile (`sarthi -p <name>`). Run `sarthi doctor` (or
 ...
 * Only these imports resolve: @sarthi/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@sarthi/plugin-sdk'

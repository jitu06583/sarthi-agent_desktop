...
Built for [Sarthi Agent](https://github.com/jitendra-singh-thakur/sarthi-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/sarthi-agent/skills/creative/ascii-video`](https://github.com/jitendra-singh-thakur/sarthi-agent/tree/main/skills/creative/ascii-video) via PR.

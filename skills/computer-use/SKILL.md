...
for the platform plumbing. The Sarthi-side `computer_use` tool exposed
in this skill is a higher-level Sarthi vocabulary; the raw cua-driver
...
When `cua-driver skills install` autodetects Sarthi (planned follow-up

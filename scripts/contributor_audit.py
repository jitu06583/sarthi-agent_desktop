...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Sarthi\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (sarthi-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "sarthi@nousresearch.com",
    "sarthi-audit@example.com",
    "nousbot@nousresearch.com",
    "sarthi@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",

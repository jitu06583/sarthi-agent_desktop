#!/usr/bin/env python3
"""Build the Sarthi Model Catalog — a centralized JSON manifest of curated models.
...
Sarthi CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Sarthi release.
...
# Ensure SARTHI_HOME is set for imports that touch it at module level.
os.environ.setdefault("SARTHI_HOME", os.path.join(os.path.expanduser("~"), ".sarthi"))

from sarthi_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Sarthi '

...
def main() -> None:
    ...
    sarthi_home = Path(tempfile.mkdtemp(prefix="sarthi-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "sarthi-gateway-smoke",
    ...
    print(json.dumps({"sarthi_home": str(sarthi_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))

#!/usr/bin/env python3
"""Build the Sarthi Skills Index — a centralized JSON catalog of all skills.
...
`sarthi skills search/install` can use it without hitting the GitHub API.
...
# Ensure SARTHI_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Sarthi Skills Index...", flush=True)

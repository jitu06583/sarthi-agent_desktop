...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        # atexit.register(_drain_token_queue_at_exit) (sarthi_state.py), which only
...
def _(rid, params: dict) -> dict:
    ...
    from sarthi_cli.nous_billing import BillingError, post_subscription_preview
...
def _(rid, params: dict) -> dict:
    ...
    billing:manage.
    """
    from sarthi_cli.nous_billing import BillingError, put_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    """
    from sarthi_cli.nous_billing import BillingError, delete_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    from sarthi_cli.nous_billing import BillingError, post_subscription_upgrade
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from sarthi_cli.nous_billing import BillingError
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        if parent_home:
            ...
            branch_owns_db = True
        home_token = (
            set_sarthi_home_override(parent_home) if parent_home else None
        )

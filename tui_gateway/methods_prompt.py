...
def _(rid, params: dict) -> dict:
    ...
    # over another app when they are back in Sarthi.
        ...
        if (
            ...
            if not is_truthy_value(params.get("confirm_truncate")):
                ...
                return _err(
                    ...
                    "(update your Sarthi client if a rewind was intended)",
                )
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            # SARTHI_HOME override (the ContextVar set on the session-create
            ...
            home_token = (
                set_sarthi_home_override(_profile_home_str)
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            # the session's SARTHI_HOME override (the ContextVar set on the
...
def _(rid, params: dict) -> dict:
    # `text` is a JSON string describing the OS window underneath the Sarthi

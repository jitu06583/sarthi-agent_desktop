...
def resolve_profile(rid, params, err_fn) -> Tuple[Optional[Any], Optional[dict]]:
    """Resolve the optional ``profile`` param to a SARTHI_HOME override token.
    ...
    return set_sarthi_home_override(str(profile_dir)), None
...
def summarize_server(name: str, cfg: dict) -> Dict[str, Any]:
    ...
    """
    from sarthi_cli.mcp_config import _oauth_tokens_present

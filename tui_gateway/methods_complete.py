...
def _(rid, params: dict) -> dict:
    ...
    def _profile_mention_items(prefix: str) -> list[dict]:
        ...
        under the 'sarthi' alias when no real profile claims that name.
        """
        out: list[dict] = []
        try:
            ...
            if "sarthi".startswith(prefix.lower()) and "sarthi" not in seen:
                out.append(
                    {
                        "text": "@sarthi",
                        "display": "@sarthi",
...
def _(rid, params: dict) -> dict:
    try:
        from sarthi_cli.inventory import build_model_options_payload
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from sarthi_cli.inventory import build_models_payload
        ...
        # Save the key to ~/.sarthi/.env via the unified credential lifecycle

...
def execute_code(
    ...
    try:
        ...
        # Ensure the sarthi-agent root is importable in the sandbox so
        # repo-root modules are available to child scripts.  We also prepend
        # the staging tmpdir so ``from sarthi_tools import ...`` resolves even
...
def build_execute_code_schema(enabled_sandbox_tools: set = None,
    ...
    description = (
        "Run a Python script that can call Sarthi tools programmatically. "
        ...
        "Also available (no import needed — built into sarthi_tools):\n"

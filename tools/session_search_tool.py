...
the get_anchored_view / get_messages_around primitives in sarthi_state.
...
from sarthi_state_common import _RESET_END_REASONS
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Sarthi conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. Sarthi renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Sarthi conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Sarthi profile's database "

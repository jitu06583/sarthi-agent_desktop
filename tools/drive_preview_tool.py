#!/usr/bin/env python3
"""Interact with the in-app browser / preview pane in the Sarthi desktop GUI.
...
def drive_preview_tool(
    ...
    if callback is None:
        return tool_error("drive_preview is only available in the Sarthi desktop app.")
...
ACT_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "the Sarthi desktop GUI — the pane open_preview opens beside this "

...
Only included in the sarthi-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Sarthi-Agent (https://github.com/jitendra-singh-thakur/sarthi-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_sarthi_home() / "cache" / "discord_capabilities.json"

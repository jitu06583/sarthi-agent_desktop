...
Trust levels:
  - builtin:   Ships with Sarthi. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.sarthi/\.env|\~/\.sarthi/\.env',
     "sarthi_env_access", "critical", "exfiltration",
     "directly references Sarthi secrets file"),
    ...
    (r'\.sarthi/config\.yaml|\.sarthi/SOUL\.md',
     "sarthi_config_mod", "critical", "persistence",
     "references Sarthi configuration files directly"),
...
# scan. `.skillignore` is the Sarthi-native name; `.clawhubignore` is honored

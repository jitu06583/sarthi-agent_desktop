#!/usr/bin/env python3
"""Reveal/focus a pane in the Sarthi desktop GUI.
...
def focus_pane_tool(pane: str) -> str:
    ...
    if not ok:
        return tool_error("Pane focus is only available in the Sarthi desktop app.")
...
FOCUS_PANE_SCHEMA = {
    "name": "focus_pane",
    "description": (
        "Reveal and focus a pane in the Sarthi desktop app when the user asks to "

...
`hey_sarthi.onnx` / `hey_sarthi.tflite` — the on-device "Hey Sarthi" hotword
...
- **Label:** the model registers as `hey_sarthi` (matches the filename).

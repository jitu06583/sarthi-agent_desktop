...
class OptionalSkillSource(SkillSource):
    ...
    OFFICIAL_REPO = "NousResearch/sarthi-agent"
...
SARTHI_INDEX_URL = "https://sarthi-agent.vercel.app/docs/api/skills-index.json"
...
def _load_sarthi_index() -> Optional[dict]:
    ...
    if sarthi_index_cache_file.exists():
        try:
            ...
            if age < SARTHI_INDEX_TTL:
                return json.loads(sarthi_index_cache_file.read_text())
        except (OSError, json.JSONDecodeError):
            pass
    ...
    try:
        ...
        sarthi_index_cache_file.write_text(json.dumps(data))
    except OSError:
        pass

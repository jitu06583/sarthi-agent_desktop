# Streaming LLM Response Support for Sarthi Agent
...
```
SARTHI_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SARTHI_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `sarthi_cli/config.py` | 1 | +streaming config defaults |

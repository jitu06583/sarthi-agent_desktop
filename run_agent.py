...
class AIAgent:
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        # ``monkeypatch.setattr("sarthi_cli.plugins.has_hook", ...)`` still
        ...
        try:
            from sarthi_cli import plugins as _plugins
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from sarthi_cli.copilot_auth import resolve_copilot_token

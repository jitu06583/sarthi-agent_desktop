"""
Sarthi CLI - Unified command-line interface for Sarthi Agent.

Provides subcommands for:
- sarthi chat          - Interactive chat (same as ./sarthi)
- sarthi gateway       - Run gateway in foreground
- sarthi gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `sarthi setup` on a fresh Pi.
    ...
    sarthi_cli/stdio.py::configure_windows_stdio() runs later from the entry

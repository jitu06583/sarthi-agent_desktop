...
Invoked by ``sarthi kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Sarthi Agent board.
...
def _profile_author() -> str:
    """Mirror of ``sarthi_cli.kanban._profile_author``."""
    return (

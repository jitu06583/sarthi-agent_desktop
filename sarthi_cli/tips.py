...
TIPS = [
    ...
    "sarthi chat --max-turns 200 overrides the default 90-iteration limit per turn.",
    ...
    'SARTHI_BACKGROUND_NOTIFICATIONS=result only pings when background tasks finish (vs all/error/off).',

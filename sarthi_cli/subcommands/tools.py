"""``sarthi tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'sarthi tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # sarthi tools list [--platform cli]
    ...
    # sarthi tools disable <name...> [--platform cli]
    ...
    # sarthi tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `sarthi tools` runs after you pick a provider that\n"

"""Sarthi skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Sarthi itself) customize the
visual appearance across the CLI, the TUI, and the desktop GUI from a single
file. Skins are defined as YAML files in ~/.sarthi/skins/ or as built-in presets.
...
``resolve_skin`` / ``skin.changed``). A skin dropped in ~/.sarthi/skins/ therefore
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        # and the TUI render the same Sarthi gold.
        "colors": {

"""Sarthi CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.sarthi/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    colors:
      banner_border: "#2563EB"            # Panel border color
      banner_title: "#2DD4BF"             # Panel title text color
      banner_accent: "#10B981"            # Section headers (Available Tools, etc.)
      banner_dim: "#059669"               # Dim/muted text (separators, labels)
      banner_text: "#FFF8DC"              # Body text (tool names, skill names)
      ui_accent: "#10B981"               # General UI accent
      ui_label: "#DAA520"                # UI labels (warm gold; teal clashed w/ default banner gold)
      ui_ok: "#4caf50"                   # Success indicators
      ui_error: "#ef5350"                # Error indicators
      ui_warn: "#ffa726"                 # Warning indicators
      prompt: "#FFF8DC"                  # Prompt text color
      input_rule: "#2563EB"              # Input area horizontal rule
      response_border: "#2DD4BF"         # Response box border (ANSI)
      status_bar_bg: "#1a1a2e"           # Status bar background
      status_bar_text: "#C0C0C0"         # Status bar default text
      status_bar_strong: "#2DD4BF"       # Status bar highlighted text
      status_bar_dim: "#8B8682"          # Status bar separators/muted text
      status_bar_good: "#8FBC8F"         # Healthy context usage
      status_bar_warn: "#2DD4BF"         # Warning context usage
    ...
    branding:
      agent_name: "Sarthi Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Sarthi "       # Response box header label
...
.. code-block:: python
    ...
    from sarthi_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#2DD4BF"
    print(skin.get_branding("agent_name"))  # "Sarthi Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.sarthi/skins/
...
Drop a YAML file in ``~/.sarthi/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces SARTHI_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces SARTHI_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Sarthi — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Sarthi Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Sarthi ",
            "prompt_symbol": "❯",
...
def get_prompt_toolkit_style_overrides() -> Dict[str, str]:
    ...
    input_rule = skin.get_color("input_rule", "#2563EB")
    title = skin.get_color("banner_title", "#2DD4BF")

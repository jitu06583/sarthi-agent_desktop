"""Durable aggregation and local export for Sarthi shared metrics."""
...
from sarthi_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "sarthi.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_sarthi_home() / "telemetry" / "shared_metrics"
        ...
        return [
            {
                ...
                "resource": {
                    "sarthi_version": row["sarthi_version"],
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Sarthi processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "sarthi_version": period_row["sarthi_version"],

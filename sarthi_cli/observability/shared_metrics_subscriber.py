"""Relay subscriber for the persisted Sarthi shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Sarthi counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Sarthi shared metric: %s",
                    metric_name,
                    exc_info=True,
                )

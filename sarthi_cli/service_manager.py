...
class S6ServiceManager:
    ...
    def _render_log_run(profile: str) -> str:
        ...
        return (
            ...
            # later then runs its log service as sarthi and crash-loops on
            ...
            f'chown sarthi:sarthi "$SARTHI_HOME/logs/gateways" 2>/dev/null || true\n'
            f'chown -R sarthi:sarthi "$log_dir" 2>/dev/null || true\n'
            f'rm -f "$log_dir/lock"\n'

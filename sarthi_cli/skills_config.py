"""
Skills configuration for Sarthi Agent.
`sarthi skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.sarthi/config.yaml under:
...
from sarthi_cli.config import cfg_get, load_config, save_config
from sarthi_cli.colors import Colors, color
from sarthi_cli.platforms import PLATFORMS as _PLATFORMS

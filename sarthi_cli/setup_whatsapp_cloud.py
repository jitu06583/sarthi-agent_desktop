...
Entry point: ``sarthi whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``sarthi_cli/main.py``).
...
Sarthi gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Sarthi to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Sarthi needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Sarthi gateway in another terminal:")
    print("         sarthi gateway")
    print()

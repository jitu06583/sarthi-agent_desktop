...
#   - credits: the billing/top-up surface; reached via /sarthi credits on Slack.
#   - billing: the terminal-billing surface (buy/auto-reload/limit); /sarthi billing.
...
_SLACK_VIA_SARTHI_ONLY = frozenset({"credits", "billing", "moa", "debug"})

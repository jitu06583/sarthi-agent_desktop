"""Client for uploading ``sarthi debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``sarthi debug share``.
...
NAS_BASE = os.environ.get(
    "SARTHI_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "sarthi-agent/debug-share"

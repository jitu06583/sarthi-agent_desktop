...
Used by ``sarthi profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``sarthi_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Sarthi Agent kanban board.
...
Rules:
  ...
  - Never write "Sarthi Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_sarthi_home())
        else:

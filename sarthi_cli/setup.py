...
_DOCS_BASE = "https://sarthi-agent.vercel.app/docs"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://sarthi-agent.vercel.app/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://sarthi-agent.vercel.app/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
...
def setup_gateway(config: dict):
    ...
    if any_messaging:
        ...
        if supports_systemd and has_legacy_sarthi_units():
            print_legacy_unit_warning()
            print()
        ...
        if service_running:
            ...
            if prompt_yes_no(
                ...
                if supports_systemd and os.geteuid() == 0:  # windows-footgun: ok — guarded by supports_systemd (Linux only)
                    print_info("  Or as a boot-time service: sarthi gateway install --system")
                print_info("  Or run in foreground:  sarthi gateway")
        else:
            ...
            if is_container():
                ...
                print_info("Start the gateway to bring your bots online:")
                print_info("   sarthi gateway              # Run in foreground")

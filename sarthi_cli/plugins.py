...
class PluginManager:
    ...
    def _discover_and_load_inner(self) -> None:
        ...
        #
        # Repo-shipped plugins live next to sarthi_cli/. Two layouts are
        ...
        # 3. Project plugins (./.sarthi/plugins/)
    ...
    def _load_plugin(self, manifest: PluginManifest) -> None:
        ...
        try:
            ...
            if register_fn is None:
                ...
                # later plugins under-reported in `sarthi plugins list`.

...
def _split_line(line: str) -> list[str]:
    try:
        ...
        from sarthi_cli._subprocess_compat import split_command_line
...
class SarthiConsoleEngine:
    ...
    def _register_defaults(self) -> None:
        self.register(("status",), "status", "Show Sarthi component status.", _status)
        self.register(("version",), "version", "Show Sarthi version information.", _version)
        self.register(("doctor",), "doctor", "Run diagnostics without auto-fix.", _doctor)
        self.register(("logs",), "logs [name] [-n N]", "Show recent Sarthi logs.", _logs)
...
def _version(_engine: SarthiConsoleEngine, args: list[str]) -> str:
    _expect_no_args(args, "version")
    from sarthi_cli._startup_fast import print_fast_version_info

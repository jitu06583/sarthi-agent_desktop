...
```bash
python ~/.sarthi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.sarthi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.sarthi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \

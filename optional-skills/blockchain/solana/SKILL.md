...
python ~/.sarthi/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.sarthi/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.sarthi/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.sarthi/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.sarthi/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.sarthi/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```

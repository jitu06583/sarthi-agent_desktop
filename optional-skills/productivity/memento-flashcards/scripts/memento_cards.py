...
Data file: $SARTHI_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SARTHI_HOME = Path(os.environ.get("SARTHI_HOME", Path.home() / ".sarthi"))
DATA_DIR = _SARTHI_HOME / "skills" / "productivity" / "memento-flashcards" / "data"

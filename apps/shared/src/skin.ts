/**
 * Canonical Sarthi skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$SARTHI_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`sarthi_cli/skin_engine.py`),
 ...
 *   • CLI     → `sarthi_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *

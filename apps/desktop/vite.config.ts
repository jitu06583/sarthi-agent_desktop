...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\sarthi\sarthi-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@sarthi/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@sarthi/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@sarthi/shared': path.resolve(__dirname, '../shared/src'),

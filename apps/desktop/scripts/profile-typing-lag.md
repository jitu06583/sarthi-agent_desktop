...
cd apps/desktop
XCURSOR_SIZE=24 SARTHI_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/sarthi-typing
# → /tmp/sarthi-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/sarthi-typing.before.heapsnapshot
# → /tmp/sarthi-typing.after.heapsnapshot
```

...
// by main.ts (`setBackgroundThrottling` driven by the merged `sarthi:active-work`
...
// (the "Sarthi idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Sarthi" wake word has NO preceding click,

 ...
 * startSarthi() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startSarthi() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startSarthi`, re-emits

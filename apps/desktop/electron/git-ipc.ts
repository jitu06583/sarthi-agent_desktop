...
export function registerGitIpc({ resolveGitBinary, resolveGhBinary }: GitIpcDeps) {
  ...
  ipcMain.handle('sarthi:git:baseBranchList', async (_event, repoPath) =>
  ...
  ipcMain.handle('sarthi:git:review:prList', async (_event, repoPath, branches, numbers) =>
    reviewPrList(repoPath, resolveGhBinary(), branches, numbers)
  )
  ipcMain.handle('sarthi:git:review:fetchPrComment', async (_event, repoPath, url) =>

...
test('parentWatchdogEnv emits an exact identity when the marker is available', () => {
  assert.deepEqual(parentWatchdogEnv(42, 'winms:1723456789123', 'nonce-1'), {
    SARTHI_PARENT_NONCE: 'nonce-1',
    SARTHI_PARENT_PID: '42',
    SARTHI_PARENT_START_MARKER: 'winms:1723456789123',
    // Spawn tag mirrored by sarthi_cli/process_identity.py — spawner create
    // time in seconds derived from the same winms marker.
    SARTHI_SPAWN: 'v1:-:serve:42:1723456789.123'
  })
})

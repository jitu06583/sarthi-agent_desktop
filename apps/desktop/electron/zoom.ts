...
export const ZOOM_STORAGE_KEY = 'sarthi:desktop:zoomLevel'
 ...
 * but forgot to emit 'sarthi:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('sarthi:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })

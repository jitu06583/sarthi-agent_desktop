...
// even though a fresh shell — and the Sarthi CLI — sees it immediately. The
// desktop's SARTHI_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\sarthi. Reading
...
//       SARTHI_HOME    REG_SZ    F:\Sarthi\data
//

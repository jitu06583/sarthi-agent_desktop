...
// registry, and the sarthi:terminal:* IPC surface. Extracted from main.ts; the
...
export function registerTerminalIpc({
  ...
  function terminalShellCommand() {
    ...
    const override = (process.env.SARTHI_DESKTOP_SHELL || (isWindows ? '' : process.env.SHELL) || '').trim()

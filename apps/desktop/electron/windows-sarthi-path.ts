 ...
 *      venv\Scripts\sarthi.exe (the console-script shim, written at the END
 ...
 * signals (venv python interpreter, venv sarthi shim, bootstrap-complete
 * marker) — gating on just the sarthi.exe console-script shim alone is the

...
const STORAGE_KEY = 'sarthi.desktop.layoutTree.v2'

writeKey('sarthi.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('sarthi.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('sarthi.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'sarthi.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'sarthi.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'sarthi.desktop.hiddenStripTabs.v1'
...
writeKey('sarthi.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__SARTHI_LAYOUT_TREE__ = {
    close: closeTreePane,

  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://sarthi-agent.vercel.app/docs' },
    ...
    expect(view.title).toBe('Failed to open sarthi-agent.vercel.app/docs')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://sarthi-agent.vercel.app/docs' },
        result: { success: true, url: 'https://sarthi-agent.vercel.app/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened sarthi-agent.vercel.app/docs')
  })
})

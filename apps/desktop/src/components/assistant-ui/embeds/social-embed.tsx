...
const SCRIPT: Record<string, { id: string; src: string }> = {
  instagram: { id: 'sarthi-ig-embed', src: 'https://www.instagram.com/embed.js' },
  tiktok: { id: 'sarthi-tt-embed', src: 'https://www.tiktok.com/embed.js' },
  twitter: { id: 'sarthi-tw-embed', src: 'https://platform.twitter.com/widgets.js' }
}

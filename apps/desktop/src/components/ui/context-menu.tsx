...
export const SARTHI_CONTEXT_MENU_TRIGGER_ATTR = 'data-sarthi-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-sarthi-context-menu-trigger="" />
  )
}

...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/sarthi'
...
const VERSION = 3
const PREFIX = 'HML' // "Sarthi Memory Loadout" — namespaces our codes like WoW's leading bytes.

import type { SarthiReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SarthiReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SarthiReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')

...
const TAKEOVER_KEY = 'sarthi.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Sarthi can't clear via the API — the user
 *  sees exactly what runs instead of Sarthi silently deleting their creds. */

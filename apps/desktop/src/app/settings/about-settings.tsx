...
const RELEASE_NOTES_URL = 'https://github.com/jitendra-singh-thakur/sarthi-agent/releases'
            ...
            <Button asChild className="ml-auto" size="sm" variant="text">
              <a
                ...
                onClick={event => {
                  ...
                  void window.sarthiDesktop?.openExternal?.(RELEASE_NOTES_URL)
                }}
                rel="noreferrer"
                target="_blank"
              >

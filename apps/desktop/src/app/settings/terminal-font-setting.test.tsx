...
vi.mock('@/sarthi', () => ({
  saveSarthiConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setSarthiConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useSarthiConfigRecord: () => ({ data: mocks.loadedConfig })
}))

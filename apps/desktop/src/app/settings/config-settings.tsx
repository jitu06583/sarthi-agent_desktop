...
import { setSarthiConfigCache, useSarthiConfigRecord } from '../hooks/use-config-record'
...
export function voiceFieldVisible(key: string, config: SarthiConfigRecord): boolean {
...
export function ConfigSettings({
  ...
  const { data: loadedConfig, isError: configLoadFailed, refetch: refetchConfig } = useSarthiConfigRecord()
  ...
  const {
    ...
    queryKey: ['sarthi-config-schema'],
    queryFn: getSarthiConfigSchema,
    staleTime: 5 * 60 * 1000
  })

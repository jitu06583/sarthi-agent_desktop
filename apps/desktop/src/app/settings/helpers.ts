...
import type { ConfigFieldSchema, SarthiConfigRecord, ToolsetInfo } from '@/types/sarthi'
...
export function getNested(obj: SarthiConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: SarthiConfigRecord, next: SarthiConfigRecord): boolean {
...
export function setNested(obj: SarthiConfigRecord, path: string, value: unknown): SarthiConfigRecord {
...
function personalityOptions(config: SarthiConfigRecord): string[] {
...
function commandProviderNames(config: SarthiConfigRecord, section: 'tts' | 'stt'): string[] {

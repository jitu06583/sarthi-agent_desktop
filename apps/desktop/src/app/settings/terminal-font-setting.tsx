...
import { saveSarthiConfig } from '@/sarthi'
...
function fontFamilyFromConfig(config: SarthiConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useSarthiConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<SarthiConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setSarthiConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="sarthi-terminal-font-families"
          ...
          <datalist id="sarthi-terminal-font-families">

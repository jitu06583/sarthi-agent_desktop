...
import type * as SarthiApi from '@/sarthi'
...
vi.mock('@/sarthi', async importOriginal => ({
  ...(await importOriginal<typeof SarthiApi>()),
...
describe('SkillsView toolset management', () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'sarthi-skill-pick', name: 'web-research', identifier: 'web-research' },
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { sarthiDesktop?: unknown }).sarthiDesktop = { connections, getAgentRoster }

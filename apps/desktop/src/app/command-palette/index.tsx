...
import { getSarthiConfigRecord, listAllProfileSessions } from '@/sarthi'
...
// Sarthi session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-sarthi',
            keywords: ['update', 'upgrade', 'sarthi', 'version', 'system', 'restart'],
            label: cc.updateSarthi,

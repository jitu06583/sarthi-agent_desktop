...
import type { ProjectInfo, SessionInfo } from '@/sarthi'
 ...
 * repo shows its branches/worktrees even when they have no Sarthi sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: SarthiGitWorktree[]
): SidebarSessionGroup[] {

...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/sarthi'
...
// highlight markers (sqlite snippet() delimiters — see sarthi_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('sarthi:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('sarthi:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Sarthi to

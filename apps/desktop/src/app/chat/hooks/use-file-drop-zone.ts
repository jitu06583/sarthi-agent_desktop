...
import { type DroppedFile, extractDroppedFiles, SARTHI_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, SARTHI_PATHS_MIME) ? 'files' : null

...
const FOCUS_EVENT = 'sarthi:composer-focus'
const INSERT_EVENT = 'sarthi:composer-insert'
const ATTACH_IMAGES_EVENT = 'sarthi:composer-attach-images'
const INSERT_REFS_EVENT = 'sarthi:composer-insert-refs'
const SUBMIT_EVENT = 'sarthi:composer-submit'
const VOICE_TOGGLE_EVENT = 'sarthi:composer-voice-toggle'
const MODEL_MENU_EVENT = 'sarthi:composer-model-menu'

...
/**
 * Nous — the canonical Sarthi desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Sarthi's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Sarthi desktop identity: GitHub's chrome carrying Nous

/**
 * Sarthi skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$SARTHI_HOME/skins/` (or a
 * built-in) resolved by `sarthi_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Sarthi authors from a prompt lights up all three surfaces from one file.
 *
...
import type { SarthiSkin, SkinColors } from '@sarthi/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: SarthiSkin): DesktopTheme | null {

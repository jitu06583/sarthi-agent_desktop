...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/sarthi-agent')).toBe('~/www/sarthi-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/sarthi-agent')).toBe('sarthi-agent')
    expect(pathLeaf('~/www/sarthi-agent')).toBe('sarthi-agent')

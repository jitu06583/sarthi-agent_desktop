...
import type { ModelOptionsResponse, SessionInfo } from '@/types/sarthi'
 ...
 *
 * Only the leading status prefix (e.g. "Sarthi is thinking...") and the
 ...
 *  resolved comment as JSON (SarthiPrComment shape); a malformed payload falls

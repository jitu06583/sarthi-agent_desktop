...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|sarthi):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.sarthiDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.sarthiDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Sarthi, and it is the surface the agent

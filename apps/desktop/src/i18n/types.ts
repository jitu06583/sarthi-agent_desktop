...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshSarthiPathTitle: string
      sshSarthiPathDesc: string
      sshSarthiPathPlaceholder: string
  ...
  commandCenter: {
    ...
    sarthiActiveSessions: (version: string, count: number) => string

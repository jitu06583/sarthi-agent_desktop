...
export const en: Translations = {
  ...
  settings: {
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Sarthi writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    gateway: {
      ...
      intro:
        'Sarthi Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Sarthi backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Sarthi inference gateway status',
      agents: 'Agents',

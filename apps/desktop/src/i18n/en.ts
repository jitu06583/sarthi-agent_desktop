...
export const en: Translations = {
  ...
  boot: {
    ready: 'Sarthi Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Sarthi settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Sarthi backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingSarthiDesktop: 'Starting Sarthi Desktop…'
    },
    errors: {
      backgroundExited: 'Sarthi background process exited.',
      backgroundExitedDuringStartup: 'Sarthi background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Sarthi backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateSarthi: 'Update Sarthi',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Sarthi Desktop.',
    ...
    native: {
      ...
      inputBody: 'Sarthi is waiting for your response.',
      turnDoneTitle: 'Sarthi finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `sarthi debug share --nous` from a terminal, or `sarthi debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Sarthi defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Sarthi backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Sarthi backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.sarthi/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Sarthi is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Sarthi asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Sarthi was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Sarthi was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Sarthi follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Sarthi can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Sarthi is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Sarthi, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Sarthi Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Sarthi runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Sarthi checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Sarthi configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Sarthi.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Sarthi gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Sarthi Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Sarthi Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Sarthi runtime managed by this app.',
      kindRemoteDesc: 'A Sarthi gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Sarthi Cloud account.',
      kindSshDesc: 'A Sarthi install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Sarthi manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Sarthi Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Sarthi backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset SARTHI_DESKTOP_REMOTE_URL and SARTHI_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Sarthi backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Sarthi backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Sarthi Cloud',
      cloudDesc: 'Sign in once to Sarthi Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Sarthi Cloud',
      cloudSignIn: 'Sign in to Sarthi Cloud',
      cloudSignedIn: 'Signed in to Sarthi Cloud',
      cloudNeedsSignIn: 'Sign in to Sarthi Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Sarthi Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Sarthi Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Sarthi Cloud',
      cloudSignedOutMessage: 'Cleared the Sarthi Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /sarthi.',
      ...
      restartingMessage: 'Sarthi Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Sarthi ${version}` : ''}`,
      ...
      sshDesc:
        'Sarthi is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshSarthiPathTitle: 'Sarthi path (optional)',
      sshSarthiPathDesc: 'Full path to the remote sarthi binary. Blank = auto-detect.',
      sshSarthiPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Sarthi found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Sarthi runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Sarthi is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Sarthi path.',
      sshErrPlatform:
        'Unsupported remote platform. Sarthi Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Sarthi on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Sarthi. Review the exact configuration below — it comes from the link, not from Sarthi.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Sarthi runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Sarthi at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via sarthi curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Sarthi builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Sarthi to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Sarthi to generate pets.',
      backgroundHint: 'You can close this — Sarthi will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Sarthi desktop' },
    ...
    sarthiActiveSessions: (version, count) => `Sarthi ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@sarthi:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Sarthi environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Sarthi did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Sarthi will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Sarthi backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Sarthi. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Sarthi backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Sarthi...',
    placeholderReconnecting: 'Reconnecting to Sarthi…',
    ...
    attachUrlDesc: 'Sarthi will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Sarthi to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Sarthi…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Sarthi…',
    ...
    unsupportedMessage: 'This version of Sarthi can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Sarthi from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Sarthi will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Sarthi desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Sarthi updater takes over in its own window and reopens Sarthi automatically when it’s done. Please don’t reopen Sarthi yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Sarthi reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Sarthi reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Sarthi?',
    blockerBody:
      'Sarthi needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Sarthi',
    foreignBlockerBody:
      'Sarthi can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Sarthi can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Sarthi needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Sarthi Desktop',
    setupChoiceDesc:
      'Connect this app to a Sarthi gateway you already run, or install Sarthi locally on this computer.',
    connectExistingTitle: 'Connect to existing Sarthi',
    ...
    installLocalTitle: 'Install Sarthi locally',
    installLocalDesc: 'Download Sarthi, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Sarthi Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Sarthi',
    remoteSetupDesc: 'Enter your gateway URL. Sarthi Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Sarthi gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/sarthi',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Sarthi gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Sarthi Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Sarthi CLI or desktop instance is running. Stop any running Sarthi instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Sarthi Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Sarthi is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Sarthi…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Sarthi',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Sarthi at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Sarthi connects automatically',
    ...
    authorizeThere: 'Authorize Sarthi there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Sarthi there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Sarthi Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Sarthi Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Sarthi will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Sarthi is restarting...',
      askRestart: 'Ask Sarthi to restart the server',
      lookingRestart: taskId => `Sarthi is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Sarthi is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Sarthi to open a page.',
      finishedRestarting: message => `Sarthi finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Sarthi could not restart the server.',
      stillWorking:
        'Sarthi is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Sarthi is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Sarthi gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.sarthi/config.yaml). Sarthi won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Sarthi needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Sarthi needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Sarthi Desktop to use Save Image.',
    restartToSaveImages: 'Restart Sarthi Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `sarthi gateway` running?'
    }
  },

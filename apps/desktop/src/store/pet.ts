...
export interface PetInfo {
  ...
  // the Sarthi "run" activity state uses the in-place running row).
 ...
 * SARTHI_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'sarthi.desktop.pet-roam.v1'

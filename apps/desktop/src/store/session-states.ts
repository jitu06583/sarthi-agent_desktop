...
import { registryBackendScopeKey } from '@sarthi/shared'
...
const TILES_KEY = 'sarthi.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'sarthi.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __SARTHI_LAYOUT_TREE__).
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__SARTHI_SESSION_TILES__ = {

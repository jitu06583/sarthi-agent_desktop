...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('sarthi.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('sarthi.desktop.unreadFinishedSessions')

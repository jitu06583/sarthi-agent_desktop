...
function identityForConnection(connection: SarthiConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: SarthiConnection | null): void {

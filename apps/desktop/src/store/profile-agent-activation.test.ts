...
const agentConn = (over: Partial<SarthiConnection> = {}): SarthiConnection =>
  ({ baseUrl: 'https://homelab.invalid', mode: 'remote', profile: 'research', ...over }) as SarthiConnection
...
const getConnectionFor =
  vi.fn<(payload: { connectionId?: null | string; profile?: null | string }) => Promise<SarthiConnection>>()
...
beforeEach(() => {
  ...
  vi.stubGlobal('window', { sarthiDesktop: { getConnection, getConnectionFor } })
})

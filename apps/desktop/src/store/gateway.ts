import { type ConnectionState, type GatewayEvent, resolveGatewayWsUrl } from '@sarthi/shared'
...
export const $gateway = atom<SarthiGateway | null>(null)
...
let primaryGateway: SarthiGateway | null = null

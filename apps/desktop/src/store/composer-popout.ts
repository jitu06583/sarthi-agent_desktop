...
const POPOUT_STORAGE_KEY = 'sarthi.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'sarthi.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'sarthi.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'sarthi.desktop.composerPopout.position'

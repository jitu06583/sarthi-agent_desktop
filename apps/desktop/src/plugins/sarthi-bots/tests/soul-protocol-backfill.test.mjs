...
test('generated protocol uses sarthi profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `sarthi profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `sarthi profiles list` for the LIVE/)
})

...
import type { SarthiPlugin, PaletteContribution } from '@sarthi/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@sarthi/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: SarthiPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:

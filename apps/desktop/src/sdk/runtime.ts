 ...
 * plugins resolve `@sarthi/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __SARTHI_PLUGIN_SDK__: sdk,
  __SARTHI_REACT__: React,
  __SARTHI_REACT_JSX__: jsxRuntime,
  __SARTHI_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@sarthi/plugin-sdk': shimUrl('__SARTHI_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__SARTHI_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__SARTHI_REACT_JSX__'),
    react: shimUrl('__SARTHI_REACT__')
  }

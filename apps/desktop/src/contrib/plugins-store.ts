 ...
 * `<sarthi home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'sarthi.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'sarthi.desktop.disabledPlugins.v1'

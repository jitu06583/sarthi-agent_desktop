...
import { getApiRequestConnection, getApiRequestProfile, sarthiApi, profileScoped } from './client'
...
async function activeConnection(): Promise<SarthiConnection> {
  ...
  return window.sarthiDesktop.getConnection(getApiRequestProfile())
}

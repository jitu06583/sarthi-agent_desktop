...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @sarthi/plugin-sdk (+ react), never `@/…`
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@sarthi/shared'],
              message: 'Plugins import only @sarthi/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]

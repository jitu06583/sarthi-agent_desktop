      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via SARTHI_BUNDLED_SKILLS /
            # SARTHI_OPTIONAL_SKILLS (see sarthi-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + SARTHI_BUNDLED_LOCALES
            # / SARTHI_OPTIONAL_MCPS, not via the wheel. Excluding them

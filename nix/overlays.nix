# nix/overlays.nix — Expose pkgs.sarthi-agent for external NixOS configs
#
...
# `pkgs.sarthi-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    sarthi-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}

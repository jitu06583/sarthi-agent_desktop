"""Tests for the shared byte formatter (sarthi_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from sarthi_cli.backup import _format_size as backup
    from sarthi_cli.checkpoints import _fmt_bytes as checkpoints
    from sarthi_cli.doctor import _human_bytes as doctor

...
The main() function in sarthi_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `sarthi -c model`
...
def _build_parser():
    """Build a minimal replica of the sarthi top-level parser."""

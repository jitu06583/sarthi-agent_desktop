"""Regression: ``sarthi update`` should take a managed checkout off autocrlf=true.
...
``sarthi update`` has to repair them.
...
from sarthi_cli.update_cmd import _normalize_managed_eol

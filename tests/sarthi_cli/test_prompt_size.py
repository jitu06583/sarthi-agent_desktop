"""Tests for the ``sarthi prompt-size`` diagnostic (issue #34667)."""
...
from sarthi_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(sarthi_home, memory_text="", user_text=""):
    mem_dir = sarthi_home / "memories"
...
def _seed_skill(sarthi_home, name, description):
    skill_dir = sarthi_home / "skills" / "demo" / name

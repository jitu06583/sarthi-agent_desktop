...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from sarthi_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SARTHI_OVERLAYS
        overlay = SARTHI_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify sarthi doctor recognizes Xiaomi env vars."""

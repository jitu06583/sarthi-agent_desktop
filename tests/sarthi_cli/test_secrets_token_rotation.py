"""Tests for `sarthi secrets bitwarden token` / `sarthi secrets onepassword token`.
...
from sarthi_cli import onepassword_secrets_cli as op_cli
from sarthi_cli import secrets_cli as bw_cli

"""Tests for the interactive session browser (`sarthi sessions browse`).
...
from sarthi_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """sarthi sessions browse should be parseable."""

"""Tests for ``sarthi approvals suggest`` (sarthi_cli/approvals_suggest.py).

Approval history in Sarthi is implied, not ledgered: the session DB
...
from sarthi_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,

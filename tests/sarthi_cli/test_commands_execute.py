...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`sarthi_cli.slash_exec.EXECUTORS`, and
...
from sarthi_cli.commands import COMMAND_REGISTRY, resolve_command
from sarthi_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,

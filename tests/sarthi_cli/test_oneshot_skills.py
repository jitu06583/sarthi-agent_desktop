...
The oneshot path builds its AIAgent directly (bypassing SarthiCLI), so the
...
from sarthi_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills

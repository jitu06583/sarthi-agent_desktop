"""Tests for `sarthi curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated SARTHI_HOME with real agent-created skills on disk."""
    ...
    from sarthi_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import sarthi_cli.curator as curator_cli

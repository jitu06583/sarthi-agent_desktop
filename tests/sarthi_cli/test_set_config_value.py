...
from sarthi_cli.config import set_config_value, config_command
...
class TestCatchAllPatterns:
    ...
    def test_case_insensitive(self, _isolated_sarthi_home):
    ...
    def test_terminal_ssh_prefix_routes_to_env(self, _isolated_sarthi_home):
...
class TestConfigYamlRouting:
    ...
    def test_nested_key(self, _isolated_sarthi_home):
        set_config_value("terminal.backend", "docker")
        config = _read_config(_isolated_sarthi_home)
        assert "docker" in config
        assert "terminal" not in _read_env(_isolated_sarthi_home)
...
class TestFalsyValues:
    ...
    def test_empty_string_routes_to_env(self, _isolated_sarthi_home):
    ...
    def test_empty_string_routes_to_config(self, _isolated_sarthi_home):
    ...
    def test_zero_routes_to_config(self, _isolated_sarthi_home):
...
class TestConfigGetUnset:
    ...
    def test_config_get_prints_structured_json(self, _isolated_sarthi_home, capsys):
        set_config_value("terminal.backend", "docker")
        capsys.readouterr()
    ...
    def test_config_get_dotted_token_yaml_key(self, _isolated_sarthi_home, capsys):
    ...
    def test_config_unset_removes_env_key(self, _isolated_sarthi_home, capsys):
        set_config_value("OPENROUTER_API_KEY", "sk-test")
        assert "OPENROUTER_API_KEY=sk-test" in _read_env(_isolated_sarthi_home)
        capsys.readouterr()

        args = argparse.Namespace(config_command="unset", key="OPENROUTER_API_KEY")
        config_command(args)

        assert "OPENROUTER_API_KEY=" not in _read_env(_isolated_sarthi_home)

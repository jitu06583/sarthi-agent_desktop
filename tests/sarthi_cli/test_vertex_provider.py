...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (sarthi_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_sarthi_overlays():
    """sarthi_cli.providers.get_provider("vertex") backs

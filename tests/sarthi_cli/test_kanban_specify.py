"""Tests for the specifier module + `sarthi kanban specify` CLI surface.
...
from sarthi_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `sarthi kanban …` argparse surface directly."""

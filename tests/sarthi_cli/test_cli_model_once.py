...
def test_cli_model_once_records_restore_and_does_not_persist(monkeypatch):
    ...
    stub._snapshot_model_runtime = cli_mod.SarthiCLI._snapshot_model_runtime.__get__(stub)
    printed = []
    ...
    monkeypatch.setattr("sarthi_cli.model_switch.resolve_display_context_length", lambda *a, **k: None)

    cli_mod.SarthiCLI._handle_model_switch(
        stub,
...
def test_cli_restore_model_runtime_snapshot_restores_agent():
    ...
    cli_mod.SarthiCLI._restore_model_runtime_snapshot(stub, snapshot)

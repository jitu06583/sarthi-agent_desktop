...
def test_pet_hatch_then_adopt_activates(monkeypatch, tmp_path):
    ...
    activated = {}
    monkeypatch.setattr("sarthi_cli.pets._set_active", lambda slug: activated.setdefault("slug", slug))
...
def test_pet_sprite_payload_includes_concrete_row_counts():
    ...
    # Current Codex rows can have more/fewer frames than Sarthi' generic

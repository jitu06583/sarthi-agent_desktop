...
def test_moa_arg_is_always_one_shot(server, session, sarthi_home):
...
def test_moa_non_preset_returns_one_shot_send(server, session, sarthi_home):
    _write_moa_config(sarthi_home, """
moa:
  default_preset: default
  presets:

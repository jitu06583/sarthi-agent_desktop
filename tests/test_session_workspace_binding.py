"""Session <-> workspace grouping key (sarthi_state.workspace_key).

The key is what `sarthi sessions list --workspace` groups/filters on. It is a
...
from sarthi_state import workspace_key

...
def test_import_loads_env_from_sarthi_home(tmp_path, monkeypatch):
    home = tmp_path / ".sarthi"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-sarthi-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-sarthi-home"

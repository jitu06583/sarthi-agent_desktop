...
The unit tests in tests/sarthi_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned sarthi-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/sarthi")
from sarthi_cli.service_manager import S6ServiceManager

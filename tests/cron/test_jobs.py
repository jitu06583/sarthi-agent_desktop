...
class TestPauseResumeJob:
    ...
    def test_pause_is_authoritative_due_jobs_do_not_fire(self, tmp_cron_dir):
        ...
        past = (_sarthi_now() - timedelta(hours=2)).isoformat()
...
class TestLateEnvRepointScopesStore:
    """A SARTHI_HOME set AFTER cron.jobs import must scope the store even
    ...
    def test_use_cron_store_override_still_wins(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("SARTHI_HOME", str(tmp_path / "env-home"))
    ...
    def test_public_io_after_late_env_repoint_leaves_old_file_untouched(
        ...
        called after a post-import SARTHI_HOME repoint must operate on the NEW
        ...
        monkeypatch.setattr(jobs, "SARTHI_DIR", sim_old_home)
        ...
        monkeypatch.setenv("SARTHI_HOME", str(new_home))

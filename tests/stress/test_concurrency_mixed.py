...
def worker_loop(worker_id: int, sarthi_home: str, result_file: str) -> None:
...
def reclaimer_loop(sarthi_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="sarthi_mixed_stress_")
    print(f"SARTHI_HOME = {home}")

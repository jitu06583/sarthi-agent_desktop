...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded sarthi-temp-hello (0.74 sec)\n"
        "Deployed sarthi-temp-hello triggers (0.42 sec)\n"
        "  https://sarthi-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://sarthi-temp-hello.serene-temple.workers.dev"

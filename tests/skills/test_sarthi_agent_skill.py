"""The `sarthi-agent` skill is what a running Sarthi knows about itself.

`website/` is never packaged, so an installed Sarthi has no local copy of the
user guide; skills ARE synced into `$SARTHI_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Sarthi can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "sarthi-agent"

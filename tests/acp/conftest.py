...
Keeps the ACP server tests offline: ``SarthiACPAgent._build_model_state``
calls ``sarthi_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import sarthi_cli.inventory as inventory

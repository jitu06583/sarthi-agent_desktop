...
thinking phase.  Sarthi's default cloud-stream stale detector
(``SARTHI_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SARTHI_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the

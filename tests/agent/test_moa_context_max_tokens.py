...
def test_aggregator_call_never_receives_reference_max_tokens(sarthi_home, monkeypatch):
...
def test_aggregator_call_uncapped_when_reference_max_tokens_unset(sarthi_home, monkeypatch):

"""Tests for the sarthi-tools-as-MCP server module surface.
...
from agent.transports.sarthi_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import sarthi_tools_mcp_server as m
    ...
    def test_expected_sarthi_specific_tools_listed(self):
        """The Sarthi-specific tools should be present so users on the
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `sarthi chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.sarthi_tools_mcp_server as m

...
engine plugins (e.g. sarthi-lcm) rely on:
...
def test_discover_context_engines_includes_plugin_registered_engines(monkeypatch):
    """Plugin-registered context engines appear in the ``sarthi plugins`` picker."""
    ...
    monkeypatch.setattr(
        "sarthi_cli.plugins.get_plugin_context_engine",

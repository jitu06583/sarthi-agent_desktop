...
def test_sarthi_meta_tolerates_non_dict():
    assert learning_graph._sarthi_meta({"metadata": "junk"}) == {}
    assert learning_graph._sarthi_meta({"metadata": {"sarthi": "junk"}}) == {}
    assert learning_graph._sarthi_meta({"metadata": {"sarthi": {"category": "x"}}}) == {"category": "x"}

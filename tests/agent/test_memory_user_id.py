...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_sarthi_user(self):
        """Without user_id or config override, should default to 'sarthi-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "sarthi-user"
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"SARTHI_HOME": "/tmp/test_sarthi"}):

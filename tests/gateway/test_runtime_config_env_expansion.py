...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("SARTHI_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("SARTHI_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("SARTHI_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path

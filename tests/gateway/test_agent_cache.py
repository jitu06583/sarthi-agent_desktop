...
class TestAgentConfigSignature:
    ...
    def test_same_config_same_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["sarthi-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["sarthi-telegram"], "")
        assert sig1 == sig2
    ...
    def test_model_change_different_signature(self):
        ...
        runtime = {"api_key": "sk-test12345678", "base_url": "https://openrouter.ai/api/v1",
                    "provider": "openrouter"}
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["sarthi-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-opus-4.6", runtime, ["sarthi-telegram"], "")
        assert sig1 != sig2
    ...
    def test_same_token_prefix_different_full_token_changes_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt1, ["sarthi-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt2, ["sarthi-telegram"], "")
        assert sig1 != sig2
    ...
    def test_provider_change_different_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt1, ["sarthi-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt2, ["sarthi-telegram"], "")
        assert sig1 != sig2
    ...
    def test_toolset_change_different_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["sarthi-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["sarthi-discord"], "")
        assert sig1 != sig2
...
class TestExtractCacheBustingConfig:
    ...
    def test_reads_compression_subkeys(self):
        ...
        assert out["compression.codex_app_server_auto"] == "sarthi"
...
class TestAgentCacheLifecycle:
    ...
    def test_cache_hit_returns_same_agent(self):
        ...
        runtime = {"api_key": "test", "base_url": "https://openrouter.ai/api/v1",
                    "provider": "openrouter", "api_mode": "chat_completions"}
        sig = runner._agent_config_signature("anthropic/claude-sonnet-4", runtime, ["sarthi-telegram"], "")
    ...
    def test_cache_miss_on_model_change(self):
        ...
        old_sig = runner._agent_config_signature("anthropic/claude-sonnet-4", runtime, ["sarthi-telegram"], "")
        agent1 = AIAgent(
            model="anthropic/claude-sonnet-4", api_key="test",
            base_url="https://openrouter.ai/api/v1", provider="openrouter",
            max_iterations=5, quiet_mode=True, skip_context_files=True,
        ...
        new_sig = runner._agent_config_signature("anthropic/claude-opus-4.6", runtime, ["sarthi-telegram"], "")
...
class TestAgentConfigSignatureUserId:
    ...
    def test_signature_changes_with_user_id(self):
        ...
        sig_a = GatewayRunner._agent_config_signature(
            "claude-sonnet-4", runtime, ["sarthi-telegram"], "", user_id="7654321"
        )
        sig_b = GatewayRunner._agent_config_signature(
            "claude-sonnet-4", runtime, ["sarthi-telegram"], "", user_id="491827364"
        )
        assert sig_a != sig_b
    ...
    def test_signature_changes_with_user_id_alt(self):
        ...
        runtime = {"provider": "anthropic", "api_key": "k", "base_url": "", "api_mode": "chat_completions"}
        sig_a = GatewayRunner._agent_config_signature(
            "claude-sonnet-4", runtime, ["sarthi-telegram"], "",
...
class TestAgentCacheMessageCountRebaseline:
    ...
    def _runner_with_db(self, db):
        from sarthi_state import AsyncSessionDB
    ...
    async def test_rebaseline_is_fail_safe_and_skips_legacy_and_pending(self, tmp_path):
        ...
        from sarthi_state import AsyncSessionDB, SessionDB
        from gateway.run import _AGENT_PENDING_SENTINEL

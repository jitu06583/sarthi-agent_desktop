"""Tests for _setup_feishu() in sarthi_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("sarthi_cli.config.save_env_value", side_effect=mock_save), \
         patch("sarthi_cli.config.get_env_value", side_effect=mock_get), \
         patch("sarthi_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("sarthi_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("sarthi_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("sarthi_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("sarthi_cli.cli_output.print_header"), \
         patch("sarthi_cli.cli_output.print_info"), \
         patch("sarthi_cli.cli_output.print_success"), \
         patch("sarthi_cli.cli_output.print_warning"), \
         patch("sarthi_cli.cli_output.print_error"), \

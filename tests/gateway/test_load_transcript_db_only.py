...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.sarthi/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at sarthi_state import time, before pytest's SARTHI_HOME monkeypatch
    fires — the autouse fixture's SARTHI_HOME override doesn't help here.)
    """
    import sarthi_state

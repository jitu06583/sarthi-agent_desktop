...
from sarthi_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/sarthi_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("sarthi_cli.lifecycle.invoke_hook")
@patch("sarthi_cli.lifecycle.finalize_session")

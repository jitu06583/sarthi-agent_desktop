"""Regression test: sarthi update must not load cryptography eagerly."""
...
assert 'sarthi_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running sarthi update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so sarthi_cli is importable,
...
import sarthi_cli.main
from sarthi_cli.update_cmd import _cmd_update_check

...
def _profile_user_agent() -> str:
    """Return a ``sarthi-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from sarthi_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"sarthi-cli/{_ver}"
    except Exception:
        return "sarthi-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # sarthi-cli UA so the catalog endpoint is reachable.

...
(3 SDK retries x 3 Sarthi retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_sarthi_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".sarthi")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Sarthi, ...) behind one endpoint.  A 429 can mean either:

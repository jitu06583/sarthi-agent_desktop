...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if active_profile == "default":
        stable_parts.append(
            ...
            "under ~/.sarthi/profiles/<name>/. Each profile has its own "
        ...
        stable_parts.append(
            ...
            f"and writes ~/.sarthi/profiles/{active_profile}/. The default "
            f"profile's data lives at ~/.sarthi/skills/, ~/.sarthi/plugins/, "
            f"~/.sarthi/cron/, ~/.sarthi/memories/ — those belong to a "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Sarthi never rebuilds or reinjects parts of it

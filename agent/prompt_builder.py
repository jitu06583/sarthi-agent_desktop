...
from sarthi_constants import get_sarthi_home, get_skills_dir, is_wsl
...
SARTHI_AGENT_HELP_GUIDANCE = (
    ...
    "the documentation at https://sarthi-agent.vercel.app/docs is your "
...
def load_soul_md(context_length: Optional[int] = None) -> Optional[str]:
    ...
    soul_path = get_sarthi_home() / "SOUL.md"

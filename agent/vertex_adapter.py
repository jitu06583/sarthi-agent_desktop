"""Vertex AI (Google Cloud) adapter for Sarthi Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Sarthi to use Gemini models via Google Cloud with
...
# who installed plain `sarthi-agent` and only later selected a Gemini model.
try:

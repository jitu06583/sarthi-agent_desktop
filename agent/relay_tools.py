"""Core NeMo Relay adapter for Sarthi tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Sarthi tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Sarthi Relay tool execution cannot run on an active event-loop thread"
    )

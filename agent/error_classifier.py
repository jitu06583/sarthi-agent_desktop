...
# ``data:`` field before Sarthi receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and Sarthi persists a content-less
...
# Request parameters that Sarthi sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # sarthi_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from sarthi_cli.plugins import get_plugin_error_classification

...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Sarthi's web-provider config and
        ...
        # native search engine for xAI sessions instead of Sarthi's
        # configured web provider (Tavily/etc.), and those results bypass
        # Sarthi's tool-trace / citation plumbing (they arrive baked into the

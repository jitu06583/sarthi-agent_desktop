...
def init_agent(
    ...
    agent._cache_ttl = "5m"
    try:
        from sarthi_cli.config import load_config as _load_pc_cfg
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        try:
            from sarthi_cli.config import load_config as _load_br_cfg
    ...
    try:
        from sarthi_cli.config import load_config as _load_sess_cfg
    ...
    try:
        from sarthi_cli.config import load_config as _load_agent_config

import { Box, type ScrollBoxHandle, stringWidth, Text } from '@sarthi/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SARTHI_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SARTHI_DEV_CREDITS), lowest priority,

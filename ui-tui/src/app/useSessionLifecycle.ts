...
import type { ScrollBoxHandle } from '@sarthi/ink'
import { evictInkCaches } from '@sarthi/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SARTHI_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }

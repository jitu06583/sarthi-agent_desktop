import type { BillingBlock, UsageModelData } from '@sarthi/shared/billing'
import type { SarthiSkin } from '@sarthi/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@sarthi/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = SarthiSkin
...
// Wire shapes now live in @sarthi/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,

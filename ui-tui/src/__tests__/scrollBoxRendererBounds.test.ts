...
import { Box, renderSync, ScrollBox, type ScrollBoxHandle, Text } from '@sarthi/ink'
import React, { useLayoutEffect, useRef } from 'react'
import { describe, expect, it, vi } from 'vitest'

import SourceBox from '../../packages/sarthi-ink/src/ink/components/Box.js'
import SourceScrollBox from '../../packages/sarthi-ink/src/ink/components/ScrollBox.js'
import SourceText from '../../packages/sarthi-ink/src/ink/components/Text.js'
import type { DOMElement } from '../../packages/sarthi-ink/src/ink/dom.js'
import Output from '../../packages/sarthi-ink/src/ink/output.js'
import { scrollFastPathStats as sourceScrollFastPathStats } from '../../packages/sarthi-ink/src/ink/render-node-to-output.js'
import { renderSync as renderSourceSync } from '../../packages/sarthi-ink/src/ink/root.js'

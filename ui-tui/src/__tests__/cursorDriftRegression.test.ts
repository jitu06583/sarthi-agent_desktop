 ...
 *
 * Symptom: in `sarthi --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@sarthi/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using sarthi --tui and as i type multiline my caret at the end will often ' +

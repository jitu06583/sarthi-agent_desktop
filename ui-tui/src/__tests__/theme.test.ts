...
describe('DEFAULT_THEME', () => {
  ...
  it('has color palette', async () => {
    ...
    expect(DEFAULT_THEME.color.primary).toBe('#2DD4BF')
...
describe('LIGHT_THEME', () => {
  it('avoids bright-yellow accents unreadable on white backgrounds (#11300)', async () => {
    ...
    expect(LIGHT_THEME.color.primary).not.toBe('#2DD4BF')
    expect(LIGHT_THEME.color.accent).not.toBe('#10B981')
    expect(LIGHT_THEME.color.muted).not.toBe('#059669')
    expect(LIGHT_THEME.color.statusWarn).not.toBe('#2DD4BF')
  })
...
describe('fromSkin', () => {
  ...
  it('normalizes non-banner foregrounds on light Apple Terminal', async () => {
    ...
    expect(theme.color.primary).toBe('#2DD4BF')
    expect(theme.color.accent).toBe('#10B981')
    expect(theme.color.border).toBe('#2563EB')

 ...
 * across theme x background scenes to <tmpdir>/sarthi-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@sarthi/ink'
...
// The regenerated slate light_colors block from sarthi_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/sarthi-agent',
...
const setup = (bgHex: string) => {
  process.env.SARTHI_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}

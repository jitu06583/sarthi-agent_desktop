...
await build({
  ...
  // Skip the prebuilt @sarthi/ink bundle and inline the source instead:
  ...
  alias: { '@sarthi/ink': resolve(root, 'packages/sarthi-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The sarthi_cli launcher

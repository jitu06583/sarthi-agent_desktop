#!/usr/bin/env python3
"""
SWE Runner with Sarthi Trajectory Format

A runner that uses Sarthi-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Sarthi-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Sarthi-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Sarthi format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Sarthi-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Sarthi-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Sarthi Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Sarthi-Agent's built-in execution environments
    and outputs trajectories in Sarthi-Agent format.
    """
    ...
    def _convert_to_sarthi_format(
        ...
        """
        Convert internal message format to Sarthi trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Sarthi trajectory format
        trajectory = self._convert_to_sarthi_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Sarthi trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Sarthi Trajectory Format")
    print("=" * 60)
